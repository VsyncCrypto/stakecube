...
public:
    ...
    void setZSccControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzSCC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSCC_clicked();
    void on_pushButtonZSccControl_clicked();
