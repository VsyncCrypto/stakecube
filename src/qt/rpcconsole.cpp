                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSCCPathCustom = GetArg("-zsccbackuppath", "");
    ...
    if(!strzSCCPathCustom.empty()) {
        ui->wallet_customzsccbackuppath->setText(QString::fromStdString(strzSCCPathCustom));
        ui->wallet_customzsccbackuppath_label->setVisible(true);
        ui->wallet_customzsccbackuppath->setVisible(true);
    }
