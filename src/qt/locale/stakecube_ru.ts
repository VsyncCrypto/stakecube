...
&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    ...
    <message>
        ...
        <translation>
Мастернода - это компьютер, на котором запущен базовый кошелек PIVX с полным узлом и для которого требуется обеспечение в 1000 SCC для обеспечения дополнительных услуг сети и, в свою очередь, регулярного получения части вознаграждения за блок. Эти услуги в себя включают:
...
<context>
    ...
    <message>
        ...
        <translation>Невозможно найти достаточное количество средств, не предназначенных для обфускации, для этой транзакции, которые не равны 1000 SCC.</translation>
    </message>
    <message>
        <source>Unable to locate enough funds for this transaction that are not equal 1000 SCC.</source>
        <translation>Не удалось найти достаточное количество средств для этой транзакции, которые не равны 1000 SCC.</translation>
    </message>
    <message>
