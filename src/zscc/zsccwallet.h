...
#ifndef STAKECUBE_ZSCCWALLET_H
#define STAKECUBE_ZSCCWALLET_H
...
public:
    ...
    void GenerateDeterministicZSCC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSCC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
