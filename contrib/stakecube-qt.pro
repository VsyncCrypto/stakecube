...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/stakecube-cli.cpp \
           src/stakecube-tx.cpp \
           src/stakecube.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/stakecube.qrc src/qt/stakecube_locale.qrc

TRANSLATIONS += src/qt/locale/stakecube_bg.ts \
                src/qt/locale/stakecube_de.ts \
                src/qt/locale/stakecube_en.ts \
                src/qt/locale/stakecube_es.ts \
                src/qt/locale/stakecube_fi.ts \
                src/qt/locale/stakecube_fr.ts \
                src/qt/locale/stakecube_it.ts \
                src/qt/locale/stakecube_ja.ts \
                src/qt/locale/stakecube_pl.ts \
                src/qt/locale/stakecube_pt.ts \
                src/qt/locale/stakecube_ru.ts \
                src/qt/locale/stakecube_sk.ts \
                src/qt/locale/stakecube_sv.ts \
                src/qt/locale/stakecube_vi.ts \
                src/qt/locale/stakecube_zh_CN.ts \
                src/qt/locale/stakecube_zh_TW.ts
