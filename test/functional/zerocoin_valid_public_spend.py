...
from fake_stake.base_test import STAKECUBE_FakeStakeTest

class zSCCValidCoinSpendTest(STAKECUBE_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSCCs..." % DENOM_TO_USE)
